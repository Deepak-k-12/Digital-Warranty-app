    ...
    <Card className="mb-4">
      <CardContent className="flex flex-col items-center py-6">
        <img
          src={user.avatar}
          alt="avatar"
          className="w-24 h-24 rounded-full mb-2 border-4 border-primary object-cover"
        />
        ...
        <div className="w-full flex flex-col gap-2 text-center">
          ...
          <div className="flex justify-between text-sm">
            <span>Friends</span>
            <span className="font-semibold text-primary">
              {user.friends.toLocaleString()}
            </span>
          </div>
        </div>
        <Button className="w-full mt-4" variantClassName="primary">
          Follow
        </Button>
      </CardContent>
    </Card>
